...
Partial Class frmPractice
    ...
    Private Sub InitializeComponent()
        ...
        btnComputeAll.Location = New Point(424, 164)
        btnComputeAll.Margin = New Padding(3, 2, 3, 2)
        btnComputeAll.Name = "btnComputeAll"
        btnComputeAll.Size = New Size(129, 29)
        ...
        tanOutput.Location = New Point(178, 226)
        tanOutput.Margin = New Padding(3, 2, 3, 2)
        tanOutput.Name = "tanOutput"
        tanOutput.Size = New Size(124, 23)
        ...
        Label8.Location = New Point(178, 209)
        Label8.Name = "Label8"
        ...
        cosOutput.Location = New Point(178, 170)
        cosOutput.Margin = New Padding(3, 2, 3, 2)
        cosOutput.Name = "cosOutput"
        cosOutput.Size = New Size(124, 23)
        ...
        Label7.Location = New Point(178, 152)
        Label7.Name = "Label7"
        ...
        Label6.Location = New Point(178, 97)
        Label6.Name = "Label6"
        ...
        Label5.Location = New Point(163, 34)
        Label5.Name = "Label5"
        ...
        txtClear.Location = New Point(441, 216)
        txtClear.Margin = New Padding(3, 2, 3, 2)
        txtClear.Name = "txtClear"
        txtClear.Size = New Size(97, 29)
        ...
        sineOutput.Location = New Point(178, 114)
        sineOutput.Margin = New Padding(3, 2, 3, 2)
        sineOutput.Name = "sineOutput"
        sineOutput.Size = New Size(124, 23)
        ...
        ' txthyp
        ' 
        txthyp.Location = New Point(33, 226)
        txthyp.Margin = New Padding(3, 2, 3, 2)
        txthyp.Name = "txthyp"
        txthyp.Size = New Size(124, 23)
        txthyp.TabIndex = 49
        ' 
        ' Label3
        ' 
        ...
        ' txtadj
        ' 
        txtadj.Location = New Point(33, 115)
        txtadj.Margin = New Padding(3, 2, 3, 2)
        txtadj.Name = "txtadj"
        txtadj.Size = New Size(125, 23)
        txtadj.TabIndex = 47
        ' 
        ' Label2
        ' 
        ...
        ' txtopp
        ' 
        txtopp.Location = New Point(33, 169)
        txtopp.Margin = New Padding(3, 2, 3, 2)
        txtopp.Name = "txtopp"
        txtopp.Size = New Size(125, 23)
        txtopp.TabIndex = 45
        ' 
        ' Label1
        ' 
        ...
        btnCosine.Location = New Point(441, 109)
        btnCosine.Margin = New Padding(3, 2, 3, 2)
        btnCosine.Name = "btnCosine"
        btnCosine.Size = New Size(97, 29)
        ...
        btnTangent.Location = New Point(543, 109)
        btnTangent.Margin = New Padding(3, 2, 3, 2)
        btnTangent.Name = "btnTangent"
        btnTangent.Size = New Size(97, 29)
        ...
        btnSine.Location = New Point(340, 109)
        btnSine.Margin = New Padding(3, 2, 3, 2)
        btnSine.Name = "btnSine"
        btnSine.Size = New Size(97, 29)
        btnSine.TabIndex = 41
        btnSine.Text = "Sine"
